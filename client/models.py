...
class Client(ExportModelOperationsMixin('client'), models.Model):
    phone_number = models.CharField(
        ...
        unique=True,
        validators=[
            RegexValidator(regex='^7[0-9]{10}$', message='Введенный номер не соответствует формату 7 XXX XXX XX XX')]
    )
    ...
    timezone = models.CharField(verbose_name="Часовой пояс",max_length=32, null=True, blank=True)
