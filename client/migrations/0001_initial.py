    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('phone_number', models.CharField(max_length=11, unique=True, validators=[django.core.validators.RegexValidator(message='Введенный номер не соответствует формату 7 XXX XXX XX XX', regex='^7[0-9]{10}$')])),
