...
def test_create_client(client):
    response = client.post(reverse('create_client'),
                           data={
...
@pytest.mark.parametrize("data, expected_status", [
    ({"timezone": "Africa/Abidjan", "phone_number": "74207175758", "mobile_operator_code": "21474a83647",
      "tag": "string"},
     400),
    ({"timezone": "Invalid/Timezone", "phone_number": "74207175758", "mobile_operator_code": 2147483647,
      "tag": "string"}, 400),
    ({"timezone": "Africa/Abidjan", "phone_number": "7427175758", "mobile_operator_code": 2147483647, "tag": "string"},
     400),
    ({"timezone": "Africa/Abidjan", "mobile_operator_code": 2147483647, "tag": "string"},
     400),
    ({"timezone": "Africa/Abidjan", "phone_number": "7427175758", "mobile_operator_code": 2147483647, "tag": "string"},
     400),
])
